...
return (
  <motion.div 
    ...
    <div className='w-screen flex overflow-x-scroll overflow-y-hidden p-10 mt-1 snap-x snap-mandatory z-0 scrollbar-thin scrollbar-track-gray-900 scrollbar-thumb-rose-800'> 
